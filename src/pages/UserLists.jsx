...
//         <Link
//           to="/add-user"
//           className="px-6 py-2 bg-blue-500 text-white rounded-md transition duration-300 hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
//         >
//           Add User
//         </Link>
//       </div>
...
//             <div className="bg-white rounded-lg shadow-lg overflow-hidden transition duration-300 hover:shadow-xl h-full">
